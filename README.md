...
7. To localize per package (Domain per Package) we'll introduce the _()-function per package-namespace.	Add the following code in the _\_init\__.py-file of the **sample**-packge:
