...
set BIN_DIR=%~dp0\..\..\IronPythonCsharp\bin\Debug\
...
set STD_MODULES=(os ntpath genericpath glob fnmatch shutil site types stat warnings linecache UserDict UserList UserString abc _abcoll ConfigParser traceback optparse types textwrap string xmlrpclib base64 struct random zipfile tempfile uuid pickle StringIO copy _weakrefset collections keyword heapq bisect __future__ hashlib weakref functools)
