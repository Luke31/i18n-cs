...
namespace Company.CodeSatelliteEn.MultiLangModule
{
    class MultiLangComponent
    {
        public void RunComponent()
        {
            ...
            var locRm = new ResourceManager("Company.CodeSatelliteEn.MultiLangModule.CompText", typeof(MultiLangComponent).Assembly);
